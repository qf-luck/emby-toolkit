...
# --- 全量扫描库内剧集任务（新版：从 Emby 获取所有剧集） ---
def task_full_scan_all_series(processor):
    """
    【全量导入+校准版】
    ...
    注意：此任务会从 Emby 获取所有剧集，适用于首次使用或存量剧集未入库的情况。
    """
    task_name = "全量扫描库内剧集"
